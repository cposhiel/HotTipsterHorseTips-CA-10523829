...
{
    public class HotTips: ICollection<HorseTip> //, IComparer<HorseTip>
    {
        //embedded list of horseTips, static to be used through this app. Implements ICollection as its interface.
        public static List<HorseTip> horseTips = new List<HorseTip>{
        ...
        //Following methods are all from ICollection.
        public int Count => horseTips.Count();

        public bool IsReadOnly => false;

        public void Add(HorseTip item)
        {
            horseTips.Add(item);
        }
        ...
        public bool Contains(HorseTip item) => horseTips.Contains(item);

        public void CopyTo(HorseTip[] array, int arrayIndex)
        {
            horseTips.CopyTo(array, arrayIndex);
        }

        public IEnumerator<HorseTip> GetEnumerator() => horseTips.GetEnumerator();



        public bool Remove(HorseTip item) => horseTips.Remove(item);

        IEnumerator IEnumerable.GetEnumerator() => horseTips.GetEnumerator();
